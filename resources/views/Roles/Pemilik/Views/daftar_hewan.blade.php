        ...
        <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-gray-800 dark:bg-gray-900 sm:px-7.5 xl:pb-1">
            ...
            <div class="max-w-full overflow-x-auto">
                <table class="w-full table-auto">
                    ...
                    <tbody>
                        @forelse ($pets as $key => $hewan)
                            <tr class="border-b border-stroke dark:border-strokedark">
                                <td class="pl-4 py-5 xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $key + 1 }}</p>
                                </td>
                                <td class="px-4 py-5 text-center">
                                    <p class="text-black dark:text-white">{{ $hewan->nama }}</p>
                                </td>
                                <td class="px-4 py-5 text-center">
                                ...
                                <td class="px-4 py-5 text-center">
                                    <p class="text-black dark:text-white">{{ $hewan->nama_ras ?? '-' }}</p>
                                </td>
                                <td class="px-4 py-5 text-center">
                                    <p class="text-black dark:text-white">{{ $hewan->jenis_kelamin }}</p>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="py-5 text-center">
                                    <p class="text-gray-500">Belum ada hewan terdaftar.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
