    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                <li><a class="font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" href="{{ route('Dashboard_Pemilik') }}">Dashboard /</a></li>
                 ...
                 <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-default dark:border-gray-800 dark:bg-gray-900">
                     <div class="flex items-center gap-4">
                        ...
                        <div>
                             ...
                             <h4 class="text-lg font-bold text-black dark:text-white">Pemilik (6)</h4>
                        </div>
                    </div>
                </div>
