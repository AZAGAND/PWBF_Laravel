            ...
            <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-default dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Pasien Hari Ini</span>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-default dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Menunggu Pemeriksaan</span>
                    </div>
                </div>
            </div>

            {{-- Card 3: Selesai Diperiksa --}}
            <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-default dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Selesai Diperiksa</span>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-default dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Jadwal Saya</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-8 rounded-3xl border border-gray-200 bg-white p-8 shadow-default dark:border-gray-800 dark:bg-gray-900">
            <div class="flex flex-col gap-4">
                <h3 class="text-2xl font-bold text-black dark:text-white">
                    Halo, Dokter {{ Auth::user()->nama }}!
                </h3>
                <p class="font-medium text-gray-500 dark:text-gray-400">
                    Semoga hari Anda menyenangkan. Anda dapat melihat daftar pasien yang perlu diperiksa dan riwayat medis melalui menu yang tersedia.
                </p>
            </div>
        </div>
    </div>
