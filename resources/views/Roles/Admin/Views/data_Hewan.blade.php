...
<head>
    ...
    <title>Manajemen Data Hewan</title>
...
<nav class="bg-blue-900 text-white sticky top-0 z-50 shadow-lg">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="font-bold text-lg">Menu Data Hewan</span>
        </div>
...
<main class="flex-grow container mx-auto px-4 py-8">
    ...
    <div class="mb-8 border-b-4 border-blue-900 pb-4">
        <h2 class="text-3xl font-bold text-blue-900 flex items-center gap-2">
            ...
            <span>Manajemen Hewan</span>
        </h2>
        <p class="text-gray-600">Data hewan peliharaan yang terdaftar pada sistem RSHP</p>
    </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4">{{ $p->rasHewan->jenisHewan->nama_jenis_hewan ?? '-' }}</td>
                        <td class="px-4 py-4">{{ $p->rasHewan->nama_ras ?? '-' }}</td>
                        <td class="px-4 py-4">{{ $p->pemilik->user->nama ?? '-' }}</td>
                        ...
                        <td class="px-4 py-4">{{ $p->tanggal_lahir }}</td>
                    ...
                    <tr>
                        <td colspan="8" class="px-4 py-10 text-center text-gray-500">
                            ...
                            <p class="text-sm">Silahkan tambahkan data hewan baru</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
