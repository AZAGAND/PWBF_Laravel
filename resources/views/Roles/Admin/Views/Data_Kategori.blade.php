...
<nav class="bg-blue-900 text-white sticky top-0 z-50 shadow-lg">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="font-bold text-lg">Menu Manajemen Kategori</span>
        </div>
...
<main class="flex-grow container mx-auto px-4 py-8">
    ...
    <div class="mb-8 border-b-4 border-blue-900 pb-4">
        ...
        <p class="text-gray-600">Kelola kategori untuk produk & kebutuhan RSHP</p>
    </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4">{{ $k->nama_kategori }}</td>
