            ...
            <form action="{{ route('pemilik.store') }}" method="POST">
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="no_wa" required placeholder="Contoh: 081234567890" value="{{ old('no_wa') }}"
                    ...
                    <div class="mb-4.5">
                        ...
                        <textarea name="alamat" rows="3" required placeholder="Masukkan alamat lengkap"
                            class="w-full rounded border border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary text-black dark:text-white @error('alamat') border-red-500 @enderror">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
