...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="rounded-sm border border-gray-200 bg-white shadow-default dark:border-gray-800 dark:bg-gray-900">
            ...
            <form action="{{ route('kode_tindakan_terapi.store') }}" method="POST">
                @csrf
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="kode" required placeholder="Masukkan kode (contoh: K001)" value="{{ old('kode') }}"
                    ...
                    <div class="mb-4.5">
                        ...
                        <textarea name="deskripsi_tindakan_terapi" required rows="3" placeholder="Masukkan deskripsi"
                            class="w-full rounded border border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary text-black dark:text-white @error('deskripsi_tindakan_terapi') border-red-500 @enderror">{{ old('deskripsi_tindakan_terapi') }}</textarea>
                    ...
                    <div class="mb-4.5">
                        ...
                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                            <select name="idkategori" required
                                ...
                                <option value="" disabled selected class="text-body dark:text-body dark:bg-gray-800">Pilih Kategori</option>
                                @foreach($kategoris as $kategori)
                                    <option value="{{ $kategori->idkategori }}" class="text-body dark:text-body dark:bg-gray-800" {{ old('idkategori') == $kategori->idkategori ? 'selected' : '' }}>
                    ...
                    <div class="mb-4.5">
                        ...
                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                            <select name="idkategori_klinis" required
                                ...
                                <option value="" disabled selected class="text-body dark:text-body dark:bg-gray-800">Pilih Kategori Klinis</option>
                                @foreach($kategori_klinis as $kk)
                                    <option value="{{ $kk->idkategori_klinis }}" class="text-body dark:text-body dark:bg-gray-800" {{ old('idkategori_klinis') == $kk->idkategori_klinis ? 'selected' : '' }}>
