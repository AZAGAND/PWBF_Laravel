...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="rounded-sm border border-gray-200 bg-white shadow-default dark:border-gray-800 dark:bg-gray-900">
            ...
            <form action="{{ route('ras.update', $rasHewan->idras_hewan) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="nama_ras" required value="{{ old('nama_ras', $rasHewan->nama_ras) }}"
                    ...
                    <div class="mb-4.5">
                        ...
                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                            <select name="idjenis_hewan" required
                                ...
                                <option value="" disabled class="text-body dark:text-body dark:bg-gray-800">Pilih jenis hewan</option>
                                @foreach($jenisHewans as $j)
                                    <option value="{{ $j->idjenis_hewan }}" 
                                        {{ old('idjenis_hewan', $rasHewan->idjenis_hewan) == $j->idjenis_hewan ? 'selected' : '' }}
