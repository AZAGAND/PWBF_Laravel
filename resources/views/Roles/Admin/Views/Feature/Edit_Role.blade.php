...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="rounded-sm border border-gray-200 bg-white shadow-default dark:border-gray-800 dark:bg-gray-900">
            ...
            <form action="{{ route('roles.update', $roleUser->idrole_user) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" value="{{ $roleUser->user->nama }}" disabled
                            class="w-full rounded border-[1.5px] border-gray-300 bg-gray-100 py-3 px-5 text-black outline-none transition disabled:cursor-default disabled:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:disabled:bg-gray-800" />
                    </div>
