            ...
            <form action="{{ route('hewan.store') }}" method="POST">
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="nama" required placeholder="Masukkan nama hewan" value="{{ old('nama') }}"
                    ...
                    <div class="mb-4.5">
                        ...
                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                            <select name="idpemilik" required
                                ...
                                <option value="" disabled selected class="text-body dark:text-body dark:bg-gray-800">Pilih Pemilik</option>
                                @foreach($pemiliks as $pemilik)
                                    <option value="{{ $pemilik->idpemilik }}" class="text-body dark:text-body dark:bg-gray-800" {{ old('idpemilik') == $pemilik->idpemilik ? 'selected' : '' }}>
                    ...
                    <div class="mb-4.5">
                        ...
                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                            <select name="idras_hewan" required
                                ...
                                <option value="" disabled selected class="text-body dark:text-body dark:bg-gray-800">Pilih Ras Hewan</option>
                                @foreach($races as $ras)
                                    <option value="{{ $ras->idras_hewan }}" class="text-body dark:text-body dark:bg-gray-800" {{ old('idras_hewan') == $ras->idras_hewan ? 'selected' : '' }}>
                    ...
                    <div class="mb-4.5">
                        ...
                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                            <select name="jenis_kelamin" required
                                ...
                                <option value="" disabled selected class="text-body dark:text-body dark:bg-gray-800">Pilih Gender</option>
                                <option value="Jantan" class="text-body dark:text-body dark:bg-gray-800" {{ old('jenis_kelamin') == 'Jantan' ? 'selected' : '' }}>Jantan</option>
                                <option value="Betina" class="text-body dark:text-body dark:bg-gray-800" {{ old('jenis_kelamin') == 'Betina' ? 'selected' : '' }}>Betina</option>
                            </select>
                            <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2">
                                <svg class="fill-current text-gray-500 dark:text-gray-400" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.29289 8.29289C5.68342 7.90237 6.31658 7.90237 6.70711 8.29289L12 13.5858L17.2929 8.29289C17.6834 7.90237 18.3166 7.90237 18.7071 8.29289C19.0976 8.68342 19.0976 9.31658 18.7071 9.70711L12.7071 15.7071C12.3166 16.0976 11.6834 16.0976 11.2929 15.7071L5.29289 9.70711C4.90237 9.31658 4.90237 8.68342 5.29289 8.29289Z" fill="currentColor"></path>
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="warna_tanda" placeholder="Contoh: Putih Belang Hitam" value="{{ old('warna_tanda') }}"
