...
<header x-data="{ menuToggle: false }"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="{{ route('Dashboard_Dokter') }}" class="lg:hidden">
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                        ...
                        <span class="text-theme-sm mr-1 block font-medium"> {{ Auth::user()->nama }} </span>
                        ...
                        <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                            <li>
                                <a href="{{ route('dokter.profile') }}"
                                    class="flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                    <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M12.0002 9.75C9.92911 9.75 8.25017 8.07107 8.25017 6C8.25017 3.92893 9.92911 2.25 12.0002 2.25C14.0712 2.25 15.7502 3.92893 15.7502 6C15.7502 8.07107 14.0712 9.75 12.0002 9.75ZM9.75017 6C9.75017 7.24264 10.7575 8.25 12.0002 8.25C13.2428 8.25 14.2502 7.24264 14.2502 6C14.2502 4.75736 13.2428 3.75 12.0002 3.75C10.7575 3.75 9.75017 4.75736 9.75017 6Z"
                                            fill="" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M19.0945 18.2396C19.3496 18.5796 19.2801 19.0614 18.9401 19.3165C18.6001 19.5716 18.1183 19.5021 17.8632 19.1621C16.8906 17.8653 15.5492 16.9242 14.0326 16.4862C13.3768 16.2968 12.6953 16.1992 12.0002 16.1992C11.3051 16.1992 10.6236 16.2968 9.96773 16.4862C8.45115 16.9242 7.10978 17.8653 6.13717 19.1621C5.88208 19.5021 5.40026 19.5716 5.06026 19.3165C4.72027 19.0614 4.65075 18.5796 4.90584 18.2396C6.11326 16.63 7.77884 15.4619 9.66114 14.9183C10.4087 14.7025 11.192 14.5913 12.0002 14.5913C12.8083 14.5913 13.5916 14.7025 14.3392 14.9183C16.2215 15.4619 17.8871 16.63 19.0945 18.2396Z"
                                            fill="" />
                                    </svg>
                                    My Profile
                                </a>
